...
var Task = function () {
    ...
    _createClass(Task, [{
        ...
        value: function setTitle(title) {
            if (title.length < 5) throw new Error("Title must be at least 5 chars");
        ...
        value: function setDate(date) {
            if (date instanceof Date == false) throw new Error('Invalid date, date must be instance of date');
